-- ============================================================
-- MIGRATION COMPLÈTE : Profil membre + validation admin
...
-- 2. Colonnes réseaux sociaux + statut validation sur members
DO $$
BEGIN
...
UPDATE "members" 
SET "profile_validation_status" = 'valide' 
WHERE "is_active" = true 
  AND ("profile_validation_status" IS NULL OR "profile_validation_status" = 'non_soumis');
