      ...
      <div className="grid grid-cols-1 gap-3 sm:gap-4 md:grid-cols-3">
        {whyPartner.map((item) => {
          ...
          return (
            <article
              key={item.title}
              className="about-reveal home-step-card group rounded-2xl border p-5 transition duration-200 hover:-translate-y-0.5"
            ...
            >
              <span
                ...
                aria-hidden
              >
                <Icon className="h-5 w-5 transition group-hover:scale-105" style={{ color: "var(--color-primary)" }} strokeWidth={2.25} aria-hidden />
              </span>
