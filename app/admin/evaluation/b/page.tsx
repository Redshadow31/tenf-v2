...
export default function EvaluationBPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0e0e10] text-white p-8">
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-bold text-white mb-2">B. Engagement Communautaire</h1>
        <p className="text-gray-400">Discord et Events serveur — Statbot</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        >
          ...
          <p className="text-gray-400 text-sm">Évaluation de l'engagement Discord</p>
        </Link>
        <Link
          href="/admin/evaluation/b/events-serveur"
          className="bg-[#1a1a1d] border border-gray-700 rounded-lg p-6 hover:border-[#9146ff] transition-colors"
        >
          <h3 className="text-xl font-bold text-white mb-2">🎉 Events serveur</h3>
          <p className="text-gray-400 text-sm">Évaluation de la participation aux events</p>
        </Link>
      </div>
