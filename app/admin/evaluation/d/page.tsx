  ...
  return (
    <div className="min-h-screen bg-[#0e0e10] text-white p-8">
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-bold text-white mb-2">D. Synthèse & Bonus</h1>
        <p className="text-gray-400">Synthèse globale et bonus</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div className="bg-[#1a1a1d] border border-gray-700 rounded-lg p-6">
          <p className="text-sm text-gray-400 mb-2">Score synthèse</p>
          <p className="text-3xl font-bold text-[#9146ff]">—</p>
        </div>
        <div className="bg-[#1a1a1d] border border-gray-700 rounded-lg p-6">
          <p className="text-sm text-gray-400 mb-2">Bonus</p>
