...
import { getPageActivityDailyStats } from "@/lib/services/pageActivityService";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const payload = await getPageActivityDailyStats(filters);
    return NextResponse.json(payload);
  } catch (error) {
    console.error("[admin/page-activity/stats] error:", error);
