...
const routes: Array<{
  ...
  { path: "/fonctionnement-tenf/decouvrir", changeFrequency: "weekly", priority: 0.85 },
  { path: "/fonctionnement-tenf/comment-ca-marche", changeFrequency: "weekly", priority: 0.85 },
  { path: "/fonctionnement-tenf/progression", changeFrequency: "weekly", priority: 0.85 },
  { path: "/fonctionnement-tenf/communaute", changeFrequency: "weekly", priority: 0.85 },
  { path: "/fonctionnement-tenf/ressources", changeFrequency: "weekly", priority: 0.85 },
