...
function SocialIcon({ icon }: { icon: string }) {
  /** Largeurs explicites : si le CSS Tailwind ne charge pas, l’icône ne casse pas toute la mise en page. */
  const iconClass = "h-5 w-5 shrink-0";
  const iconDim = { width: 20, height: 20 } as const;

  switch (icon) {
    case 'discord':
      return (
        <svg {...iconDim} className={iconClass} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
